...
llvm.func @triton_gen.cache_control(%arg0: !llvm.ptr) {
  // CHECK:      llvm.func @triton_gen.cache_control(%arg0: !llvm.ptr)
  // CHECK-NEXT:   %0 = triton_gen.cache_control %arg0, 0, 1 : !llvm.ptr
  %0 = triton_gen.cache_control %arg0, 0, 1 : !llvm.ptr
  llvm.return
}
